...
$(document).ready(function() {
    ...
    function init() {
        // Stars
        setInterval(() => { $('.intro--star-one').toggleClass('intro--star--active'); }, 3000);
        setInterval(() => { $('.intro--star-two').toggleClass('intro--star--active'); }, 7700);
        setInterval(() => { $('.intro--star-three').toggleClass('intro--star--active'); }, 4500);
        setInterval(() => { $('.intro--star-four').toggleClass('intro--star--active'); }, 12000);
